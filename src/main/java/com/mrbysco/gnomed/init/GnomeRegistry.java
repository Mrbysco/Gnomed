...
public class GnomeRegistry {
	...
	public static final net.minecraftforge.registries.RegistryObject<Item> GNOME_HAT = ITEMS.register("gnome_hat", () -> new GnomeHatItem(new Item.Properties()));
	public static final net.minecraftforge.registries.RegistryObject<Item> GNOME_SPAWN_EGG = ITEMS.register("gnome_spawn_egg", () -> new ForgeSpawnEggItem(() -> GnomeRegistry.GNOME.get(), 1189750, 13442571, new Item.Properties()));

	public static final net.minecraftforge.registries.RegistryObject<EntityType<Gnome>> GNOME = ENTITY_TYPES.register("gnome", () -> register("gnome", EntityType.Builder.<Gnome>of(Gnome::new, MobCategory.CREATURE).sized(0.5F, 0.8F)));

	public static final net.minecraftforge.registries.RegistryObject<SoundEvent> GNOME_SPAWN = SOUND_EVENTS.register("gnome.summon", () -> new SoundEvent(new ResourceLocation(Reference.MOD_ID, "gnome.summon")));
	...
	public static final net.minecraftforge.registries.RegistryObject<SoundEvent> GNOME_DEATH = SOUND_EVENTS.register("gnome.death", () -> new SoundEvent(new ResourceLocation(Reference.MOD_ID, "gnome.death")));
