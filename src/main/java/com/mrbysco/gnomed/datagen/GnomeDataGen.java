...
public class GnomeDataGen {
	...
	public static void gatherData(GatherDataEvent event) {
		...
		if (event.includeServer()) {
			generator.addProvider(event.includeServer(), new GnomeLoot(packOutput, lookupProvider));
	...
	private static class GnomeLoot extends LootTableProvider {
		public GnomeLoot(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider) {
